...
<?php if (!$is_cobrador): ?>
<!-- MODAL FALTANTES PDF -->
<div class="modal-overlay" id="modal-faltantes-pdf">
    <div class="modal-box" style="max-width:400px">
        <div class="modal-header">
            <div class="modal-title"><i class="fa fa-user-slash"></i> Clientes que Faltaron Cobrar</div>
            <button class="modal-close" onclick="closeModal('modal-faltantes-pdf')">✕</button>
        </div>
...
function anularPago(ptId, nombre) {
  ...
  document.getElementById('anular-pt-id').value = ptId;
